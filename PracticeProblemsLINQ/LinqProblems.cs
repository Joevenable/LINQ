...
namespace PracticeProblemsLINQ
{
    public static class LinqProblems
    {
        ...
        public static List<string> RunProblem2(List<string> names)
        {
            ...
            //return
            return (List<string>)uniqueNames;
        }
        #endregion
        ...
        {
            //code
            var uniqueNames = customers.Where(n => n.Equals("Mike"));
            //return
            return (Customer)uniqueNames;
        }
        #endregion
        ...
        {
            //code
            var ID3Customer = customers.Single(c => c.Id == 3);
            ID3Customer.FirstName = "Bart";
            ID3Customer.LastName = "Star";
            
            //return
            return (Customer)ID3Customer;
        }
        #endregion
        ...
        {
            //code
            var averageGrade = classGrades.OrderByDescending(g => g.Length);
